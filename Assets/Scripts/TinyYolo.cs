...
public class TinyYolo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ops = new ComputeOps(ComputeShaderSingleton.Instance.kernels,
                                     ComputeShaderSingleton.Instance.referenceKernels, verbose: false);
    }
    ...
    public void doPredict(Texture2D texture) {
        ...
        var preprocessed = ops.Mul(new Tensor[] { input, premulTensor });
